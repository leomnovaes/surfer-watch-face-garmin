#!/usr/bin/env python3
"""Annotate the Surf Mode (swell view) screenshot with labeled manhattan-style arrows."""
from PIL import Image, ImageDraw, ImageFont

img = Image.open("screenshot-surf-swell.png").convert("RGBA")
orig_w, orig_h = img.size

# Canvas offset (where the 176x176 watch screen starts in the screenshot)
# Adjust if needed — these are approximate based on simulator window chrome
CX, CY = 98, 161
...
COLORS = [
    ...
    (60, 140, 220, 255),   # blue
    (60, 180, 80, 255),    # green
    (200, 140, 40, 255),   # orange
    (160, 60, 200, 255),   # purple
    (40, 180, 180, 255),   # teal
    (200, 60, 140, 255),   # pink
    (120, 120, 60, 255),   # olive
]
...
canvas.save("screenshot-surf-swell-annotated.png")
print(f"Saved screenshot-surf-swell-annotated.png ({new_w}x{new_h})")
